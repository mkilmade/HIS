...
<body>
	...
	<form action="results.php" method="post">
		<p>
			<strong>Choose Result Order:</strong><br /> <select
				name="searchorder">
				<option value="horse">Horse</option>
				<option value="trainer">Trainer</option>
				<option value="jockey">Jockey</option>
			</select> <br>
			<br> <strong>Race Information:</strong><br />
		...
		<table>
			...
			<tr>
				<td><input type="date" id="race_date" name="race_date"
					value="2018-01-23"></td>
				<td><select name="race">
				...
				<td><input type="radio" value="TRUE" id="turf" name="turf">Turf<br>
				...
				<td><select name="track_condition">
		...
		<table>
			...
			<tr>
				...
				<td><input type="radio" value="TRUE" id="favorite" name="favorite">Favorite<br>
					<input type="radio" value="FALSE" id="favorite" checked
					name="favorite">Not Favorite</td>
